...
public class Tortoise {
    public static int[] race(int v1, int v2, int g) {
        ...
        double differenceInSpeed = v2 - v1;
        int time = (int)((g /differenceInSpeed)*3600);
        int hours = time/3600;
...
//        speed of 720 feet per hour. Young B knows she runs faster than A,
...
//        v2 (B's speed, integer > 0) and a lead g (integer > 0) how long will
